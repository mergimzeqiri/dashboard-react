               ...
               <h2 className='wrapperTitle'>Champion</h2>
                <img  className='championPic' src={ChamionPic}/>
                 <div className='nameAndNumber'>
                   <h1 className='championNumber'>{data[0]?.permanentNumber}</h1>
                  <h1 className='championName'>{data[0]?.givenName +" "+ data[0]?.familyName}</h1>
                  <img className='Flag' src={BritishFlag}/>
               </div>
            <img className='helmetPic' src={HelmetPic}/>
        </div>

        <div className='rightWrapper'>{driverData&&<DriverInfoTable data={driverData}/>}
        </div>
    </div>
  )
}
