...
export default function ChampionInfo() {
  ...
  const { isLoading, data } = useQuery(["driver-api", id], driverApi);
  ...
  return (
    <div className="Wrapper">
      <div className="firstWrapper">
        {isLoading ? (
          <p className="isLoading">The page is loading , Please Wait..</p>
        ) : (
          <>
            {" "}
            ...
            <div className="Wrapper-Champion">
              {data && (
                <>
                  <Table data={rowName1} button={false} />
                </>
              )}
            </div>
          </>
        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="winnerTable">
              {data && (
                <>
                  <Table data={rowName2} button={true} />
                </>
              )}
            </div>
          </>
